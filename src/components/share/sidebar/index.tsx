...
import { HiCode, HiHome, HiRefresh } from 'react-icons/hi'
          ...
          <div className='flex items-center justify-between'>
            <div className='flex items-center justify-start'>
              ...
              <a href='/' className='flex ml-2 md:mr-24'>
                <img className='h-12 mr-3 block dark:hidden' src='/img/pollinationxAsset_1.png' alt='PollinationX Logo' />
                <img className='h-12 mr-3 hidden dark:block' src='/img/pollinationxAsset_1.png' alt='PollinationX Logo' />
              </a>
            </div>
          ...
          <ul className='space-y-2 font-medium'>
            <li>
              <a href='#' className='flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-neutral-100 dark:hover:bg-neutral-700'>
                ...
                <span className='ml-3'>{t('PX NFTs')}</span>
              </a>
            </li>
            <li>
              <a
                href='https://wiki.pollinationx.io/developer-section/api-reference'
                target='_blank'
                className='flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-neutral-100 dark:hover:bg-neutral-700'
              >
                <HiCode className='text-2xl text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white' />
                <span className='ml-3'>{t('developers')}</span>
              </a>
            </li>
          </ul>
        </div>
            ...
            <div className='relative bg-neutral-800 p-3 shadow-xl'>
              {account.nfts?.length > 0 ? (
                <div>
                  ...
                  <h2 className='text-md font-bold text-pollinationx-honey mt-3'>
                    {account.nfts[account.defaultNftIndex]?.title} <label className='text-xs text-pollinationx-grey'>({t('selected')})</label>
                  </h2>
                </div>
              ) : (
