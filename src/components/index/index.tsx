              ...
              <div className='block rounded-lg bg-white shadow-lg dark:bg-neutral-800'>
                <div className='g-0 lg:flex lg:flex-wrap'>
                  <div className='px-4 md:px-0 lg:w-6/12'>
                    <div className='md:mx-6 md:p-12'>
                      <div className='text-center'>
                        <img className='mx-auto w-80 block dark:hidden' src='/img/pollinationxAsset_1.png' alt='PollinationX Logo' />
                        <img className='mx-auto w-80 hidden dark:block' src='/img/pollinationxAsset_1.png' alt='PollinationX Logo' />
                      </div>
                      <form>
                  ...
                  <div
                    ...
                    style={{ background: 'linear-gradient(to right, #222222, #FAB432' }}
                  >
