...
const immu3Testnet = {
  ...
  blockExplorers: {
    etherscan: { name: 'Immu3 EVM TestNet', url: 'https://evmexplorer.tanssi-chains.network/?rpcUrl=https%3A%2F%2Ffraa-flashbox-2800-rpc.a.stagenet.tanssi.network' },
    default: { name: 'Immu3 EVM TestNet', url: 'https://evmexplorer.tanssi-chains.network/?rpcUrl=https%3A%2F%2Ffraa-flashbox-2800-rpc.a.stagenet.tanssi.network' }
  }
} as const satisfies Chain
...
const chains = [polygonMumbai, artheraTestnet, sepolia, immu3Testnet, oasisSapphireTestnet, metisSepoliaTestnet, beresheetEVM, mantleTestnet, zetachainTestnet,fantomTestnet,gnosisTestnet,fantomSonicBuildersTestnet]
